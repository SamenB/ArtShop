            ...
            <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "3rem" }}>
                    <div style={{ display: "grid", gridTemplateColumns: "minmax(0, 1.3fr) minmax(0, 1fr)", gap: "4rem" }} className="checkout-grid">
                        ...
                        <OrderSummary items={items} promoApplied={promoApplied} discountAmount={discountAmount} cartTotal={cartTotal} currentTotal={currentTotal} convertPrice={convertPrice} />
