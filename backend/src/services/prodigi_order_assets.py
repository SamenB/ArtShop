...
PREPARED_ASSET_ROLE_BY_CATEGORY = {
    ...
    "paperPrintBoxFramedMounted": "master",
    "paperPrintClassicFramed": "master",
    "paperPrintClassicFramedMounted": "master",
    "canvasRolled": "master",
...
_LEGACY_FALLBACK_ROLES = {
    ...
    "paperPrintBoxFramedMounted": ["clean_master"],
    "paperPrintClassicFramed": ["clean_master"],
    "paperPrintClassicFramedMounted": ["clean_master"],
...
class ProdigiOrderAssetService:
    ...
    async def prepare_order_asset(
        ...
        *,
        ...
        return self.render_from_master(
