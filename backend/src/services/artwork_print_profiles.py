...
CATEGORY_PROFILE_DEFAULTS: dict[str, dict[str, Any]] = {
    ...
    "paperPrintBoxFramed": {
        ...
        "crop_strategy": "cover",
        "safe_margin_pct": 3.0,
        "mount_safe_margin_pct": 5.0,
        "wrap_margin_pct": 0.0,
        "edge_extension_mode": "none",
        "background_fill": "none",
        "notes": [
            "Keep critical composition slightly farther from the edges for framed presentation.",
            "If a mount is enabled later, review the inner window crop before publishing.",
        ],
    },
    "canvasRolled": {
        "prodigi_sizing": "fillPrintArea",
    ...
    "canvasStretched": {
        ...
        "background_fill": "none",
        "notes": [
            "Mirror wrap stays the safest default until the artist approves another edge treatment.",
            "Run a manual review on all stretched canvases to confirm the wrapped sides remain elegant.",
        ],
    },
    "canvasClassicFrame": {
        "prodigi_sizing": "fillPrintArea",
        ...
        "background_fill": "none",
        "notes": [
            "Classic frames can hide a small edge area, so keep focal elements away from the perimeter.",
        ],
    },
    "canvasFloatingFrame": {
        "prodigi_sizing": "fillPrintArea",
        ...
        "background_fill": "none",
        "notes": [
            "Floating frames reward slightly cleaner edge handling because the front edge stays visually exposed.",
        ],
    },
}
